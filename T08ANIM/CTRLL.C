...
static VOID VG6_CtrlRender( vg6UNIT_Ctrl *Uni, vg6ANIM *Ani )
{
...
//    return NULL;
//  /* Setup unit methods */
//  Uni->VG6_CtrlResponse = (VOID *)VG6_CtrlResponse;
//  Uni->VG6_CtrlRender = (VOID *)VG6_CtrlRender;
//  return (vg6UNIT *)Uni;
//}  